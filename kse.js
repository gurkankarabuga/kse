...
function getEnergyCoefficient(id) {
    const coefficients = {
        ...
        'natural-gas-electricity': 0.5,
        'nuclear-electricity': 0.5,
        'hydro-electricity': 0.5,
        'wind-electricity': 0.5,
        'solar-electricity': 0.5,
        'biomass-electricity': 0.5,
        'natural-gas-consumption': 2.75,
        'gasoline-consumption': 2.3,
        'diesel-consumption': 2.3,
        'lpg-consumption': 2.3,
        'motorin-consumption': 2.3,
        'coal-consumption': 2.5,
        'fuel-oil-consumption': 2.5,
        'mazot-consumption': 2.5
    };
...
function getTransportCoefficient(id) {
    const coefficients = {
        'company-gasoline-cars': 2.3,
        'company-diesel-cars': 2.6,
        'company-lpg-cars': 2.6,
        'company-electric-cars': 0.5,
        'company-hybrid-cars': 1.5,
        'personal-car-usage': 2.3,
        'public-transport-usage': 0.1,
        'bicycle-usage': 0,
        'walking-distance': 0,
        'short-flights': 250,
        'medium-flights': 500,
...
function getProcessCoefficient(id) {
    const coefficients = {
        'ammonia-production': 1.8,
        'nitric-acid-production': 1.7,
        'adipic-acid-production': 1.6,
        'iron-steel-production': 1.9,
        'cement-production-industrial': 1.1,
        'ceramic-production': 1.2,
